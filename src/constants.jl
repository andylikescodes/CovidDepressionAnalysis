...
const DEMOGRAPHICS = ["PROLIFIC_PID", "Sex", "Education", "Income_HH", "DemM7_KNN"]
...
const EXTERNAL = [ "slope_new_cases", "slope_new_deaths", "GatheringStrictness_KNN", "Mandatory_business_closure", "Mandatory_PPE_masks"]
...
const DEMOGRAPHICS_OUTPUT_NAME = ["PROLIFIC_PID", "Gender", "Education", "Income", "Political_Views"]
const PSYCHOLOGICAL_OUTPUT_NAME = ["Depression", "Stress", "Anxiety", "Fear_COVID", "Emotional_Support", "Loneliness"]
const EXTERNAL_OUTPUT_NAME =  ["slope_new_cases", "slope_new_deaths", "GatheringStrictness", "Mandatory_business_closure", "Mandatory_PPE_masks"]
