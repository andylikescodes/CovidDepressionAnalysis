...
IPW_estimation("output/IP_weighted_sources/w6.csv", 100)
IPW_estimation("output/IP_weighted_sources/w8.csv", 100)
IPW_estimation("output/IP_weighted_sources/w10.csv", 100)
IPW_estimation("output/IP_weighted_sources/w12.csv", 100)
IPW_estimation("output/IP_weighted_sources/w14.csv", 100)
IPW_estimation("output/IP_weighted_sources/w16.csv", 100)