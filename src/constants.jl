...
const EXTERNAL = [ "slope_new_cases", "slope_new_deaths", "GatheringStrictness_KNN", "Mandatory_business_closure", "Mandatory_PPE_masks", "gatherBan_order_code", "Mandatory_SAH", "stayHome_order_code", "cvd_cases_7d_avg", "cvd_deaths_7d_avg", "ESTIMATESBASE2020"]
...
const EXTERNAL_OUTPUT_NAME =  ["slope_new_cases", "slope_new_deaths", "GatheringStrictness", "Mandatory_business_closure", "Mandatory_PPE_masks", "gatherBan_order_code", "Mandatory_SAH", "stayHome_order_code", "cvd_cases_7d_avg", "cvd_deaths_7d_avg", "State_Population"]
